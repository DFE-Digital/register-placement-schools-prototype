...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      const items = JSON.parse(fs.readFileSync(path.join(__dirname, '/data/seed-school-education-phases.json'), 'utf8'))
      ...
      for (const item of items) {
        ...
        await queryInterface.bulkInsert('school_education_phases', [baseFields], { transaction })
      ...
      // console.error('School education phase seeding error with revisions and activity logs:', error)
      console.error('School education phase seeding error:', error)
