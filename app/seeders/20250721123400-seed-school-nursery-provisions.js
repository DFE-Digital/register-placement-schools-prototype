...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      const items = JSON.parse(fs.readFileSync(path.join(__dirname, '/data/seed-school-nursery-provision.json'), 'utf8'))
      ...
      for (const item of items) {
        ...
        //   revisionTable: 'school_nursery_provision_revisions',
        //   entityId: item.id,
        ...
        //   revisionTable: 'school_nursery_provision_revisions',
        //   revisionId,
        //   entityType: 'school_nursery_provision',
        //   entityId: item.id,
        //   revisionNumber,
      ...
      // console.error('School nursery provision seeding error with revisions and activity logs:', error)
      console.error('School nursery provision seeding error:', error)
